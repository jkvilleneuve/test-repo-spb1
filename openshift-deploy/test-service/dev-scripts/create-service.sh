...
ssh root@172.17.78.9 mkdir -vp ${WORK_DIR}/dev/${MODULE_NAME} 2>/dev/null
ssh root@172.17.78.9 rm -rf ${WORK_DIR}/dev/${MODULE_NAME}/${MODULE_NAME}.*
scp ${BUILD_SCRIPT_DIR}/tmp/${MODULE_NAME}.* root@172.17.78.9:${WORK_DIR}/dev/${MODULE_NAME}/
ssh root@172.17.78.9 "cd ${WORK_DIR}/dev/${MODULE_NAME};. ${MODULE_NAME}.deploy-module.sh"
